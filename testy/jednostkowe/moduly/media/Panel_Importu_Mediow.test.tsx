...
describe("Panel_Importu_Mediow", () => {
  it("opisuje aktualny import jako pojedynczy plik wideo lub grafiki", () => {
    const widok = renderToStaticMarkup(
      <Panel_Importu_Mediow
        rozszerzeniaMediow={[".mp4", ".webm", ".mov", ".mkv", ".png"]}
    ...
    expect(widok).toContain("image/png");
    expect(widok).toContain(".png");
    expect(widok).toContain("Wybierz plik");
  });
});
